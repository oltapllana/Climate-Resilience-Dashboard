...
export const PUBLIC_URL = "https://climate-dashboard-podujeva.onrender.com";
export const SOCIAL_IMAGE_URL = `${PUBLIC_URL}/favicon.svg`;
...
export function documentMetadata(t) {
  return [
    ...
    { property: "og:image:alt", content: t("appTitle") },
    ...
    { name: "twitter:title", content: t("appTitle") },
